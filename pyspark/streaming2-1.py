...
'''
usage:
MASTER=spark://{MASTER_URL}.compute-1.amazonaws.com:7077 bin/pyspark streaming2-1.py
'''
...
CHECKPOINT_DIR = 'hdfs://{}/user/ubuntu/checkpoint2_1/'.format(MASTER_URL)
TASK_DIR = 'task2_1'
...
def sum_delay(fields):
    ...
    return (orig, carrier), (total_delay, 1)
